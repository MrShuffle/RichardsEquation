# -*- coding: utf-8 -*-
"""
Created on Sat Sep 10 17:57:21 2022
...
from RichardsEqFEM.source.MatrixAssembly.classLscheme import Newton_scheme
...
scheme = Newton_scheme(dt,d,g,order,psi_t,K,theta,K_prime,theta_prime,f)
