# -*- coding: utf-8 -*-
"""
Created on Thu Aug 25 17:18:22 2022
...
#K_prime = sp.lambdify([x],K_prime)
#theta_prime = sp.lambdify([x],theta_prime)


#K_div = divergence(K(theta(u(w,x,y))*grav_vec,[x,y])
                   
#theta = sp.lambdify([x],theta)
def K(thetaa):
    # if thetaa ==the_s:
    #     val = k_abs
    # else:
...
for j in range(timesteps):
        ...
        psi_plot = np.resize(psi,(psi.shape[1],))
