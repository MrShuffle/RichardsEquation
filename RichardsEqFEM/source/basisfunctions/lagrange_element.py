...
class finite_element:
    def __init__(self, degree):
        ...
        self.poly_dim = int(
            (degree + 1) * (degree + 2) / 2
        )  # dimension of mononomial basis of polynomials
        
        # Coordinates of reference triangle
        self.pts = np.array([[0, 0], [1, 0], [0, 1]])
        ...
        # Create vandermonde matrix on refrence triangle
        V = vandermonde(self.pts, self.degree)
        
        # Comptute inverse of Vandermonde matrix
